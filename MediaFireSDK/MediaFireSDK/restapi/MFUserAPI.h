...
/**
 ...
 [Developer Documentation](https://www.mediafire.com/developers/user.php#accept_tos)
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#fetch_tos)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#get_avater)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#get_info)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#get_limits)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#get_login_token)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#get_session_token)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#get_settings)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#link_facebook)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#link_twitter)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#register)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#set_avatar)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#set_settings)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#unlink_facebook)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#unlink_twitter)
 for list of valid parameters.
...
/**
 ...
 @param parameters Dictionary with API parameter parameters. See
 [Developer Documentation](https://www.mediafire.com/developers/user.php#update)
 for list of valid parameters.
